...
import 'package:lakhimpur_kheri/screens/news/aaa_outside_from_module/a_news_app/news_app_main.dart';
              ...
              GestureDetector(
                  ...
                  onDoubleTap: () {
                    ...
                    Navigator.of(context).push(
                        new MaterialPageRoute(builder: (_) => new NewsHome()));
                  }),
              SizedBox(
                width: 15.0,
              ),
            ...
            children: <Widget>[
              ...
              GestureDetector(
                  ...
                  onDoubleTap: () {
                    // Update the state of the ap  .then((val)=>{_getRequests()})
                    Navigator.of(context).push(new MaterialPageRoute(
                        builder: (_) => new NewsFitnessAppHomeScreen()));
                  }),
              SizedBox(
                width: 15.0,
              ),
